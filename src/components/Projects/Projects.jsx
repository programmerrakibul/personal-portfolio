...
import { SiMongodb, SiExpress, SiTailwindcss, SiFirebase, SiNextdotjs, SiVite } from "react-icons/si";
...
const Projects = () => {
  const projects = [
    {
      title: "Labora",
      description: "Labora is a modern freelance job platform connecting skilled professionals with clients worldwide.",
      image: laboraImg,
    ...
    {
      title: "KidVenture",
      description: "KidVenture brings the magic of our local toy store directly to you, making it easy to discover and shop our curated collection of fun, educational, and imaginative toys. We're your trusted partner in creating unforgettable childhood memories through the power of play.",
      image: kidVentureImg,
    ...
    {
      title: "CHRONOS",
      description: "This is more than a blog. It's the chronicle of your journey. Capture your evolving thoughts, document your passions, and build a legacy of words that stands the test of time.",
      image: chronosImg,
    ...
    {
      title: "Hero.IO",
      description: "At HERO.IO, we design web applications that blend creativity with functionality—making your digital life smoother, smarter, and more delightful. We believe great design is more than aesthetics—it's about intuitive experiences that empower users to do more with less effort.",
      image: heroIoImg,
          ...
          <div className="relative z-10">
            ...
            <div className="text-center space-y-4 mb-12 md:mb-20">
              ...
              <p className="text-sm sm:text-base md:text-lg lg:text-xl text-base-content/70 leading-relaxed max-w-2xl mx-auto">
                Showcasing my recent work and creative solutions built with modern technologies
              </p>
            </div>
